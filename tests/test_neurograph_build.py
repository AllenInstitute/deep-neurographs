...
if __name__ == "__main__":
    ...
    swc_dir = f"{root_path}/swcs/{pred_id}"
    mistake_log_path = f"{root_path}/mistake_logs/{pred_id}.txt"

    # Build graph
    neurograph = ng.NeuroGraph()
    neurograph = intake.generate_immutables(neurograph, bucket, swc_dir)
    neurograph.generate_mutables()
    neurograph.visualize_mutables()
    print("Graph is built...")
    print("Number of nodes:", neurograph.num_nodes())
    print("Number of immutable edges:", len(neurograph.immutable_edges))
    print("Number of mutable edges:", len(neurograph.mutable_edges))
    print("")
